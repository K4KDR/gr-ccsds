...
%template(constellation_ccsds_qpsk_axis_sptr) boost::shared_ptr<gr::ccsds::constellation_ccsds_qpsk_axis>;
%pythoncode %{
constellation_ccsds_qpsk_axis_sptr.__repr__ = lambda self: "<CCSDS QPSK constellation (on Axis)>"
constellation_ccsds_qpsk_axis = constellation_ccsds_qpsk_axis.make;
%}