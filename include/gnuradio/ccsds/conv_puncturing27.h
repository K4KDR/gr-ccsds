#ifndef CCSDS_CONV_PUNCTURING27_H
#define CCSDS_CONV_PUNCTURING27_H
...
namespace gr {
  namespace ccsds{
	 ...
	 */
	inline std::shared_ptr<bool[]> get_pattern(const punct_t punct) {
		// allocate memory
		std::shared_ptr<bool[]> pattern( new bool[get_pattern_len(punct)] );
...
#endif /* CCSDS_CONV_PUNCTURING27_H */
