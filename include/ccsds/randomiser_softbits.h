#ifndef INCLUDED_CCSDS_RANDOMIZER_SOFTBITS_H
#define INCLUDED_CCSDS_RANDOMIZER_SOFTBITS_H
...
namespace gr {
  namespace ccsds {
      ...
      *	 operation (sign inversion on 1). The pseudo random sequence is
	  *  generated by an 8-bit linear feedback shift register as defined in
	  *  ECSS.
      *
      *  \ingroup telemetry
      *
      ...
      */
     class CCSDS_API randomiser_softbits : virtual public gr::sync_block
     {
     public:
	typedef boost::shared_ptr<randomiser_softbits> sptr;
	/*
...
#endif /* INCLUDED_CCSDS_RANDOMIZER_SOFTBITS_H */
