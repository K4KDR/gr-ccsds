...
namespace gr {
  namespace ccsds {
    ...
    conv_encode27_aux::conv_encode27_aux(uint8_t gen_poly_c1, uint8_t gen_poly_c2, conv_puncturing27::punct_t puncturing) :
    		...
    		d_PUNCT_LEN(conv_puncturing27::get_pattern_len(puncturing))
    {
    	d_state = 0;
    	d_punct_count = 0;
    ...
    conv_encode27_aux::~conv_encode27_aux() {
    	// nothing to do
    }
    
    void conv_encode27_aux::encode(uint16_t& output_bits, unsigned char input_byte) {
