...
namespace gr {
  namespace ccsds {
    ...
    class dll_cc_impl : public dll_cc
    {
    private:
    ...
    public:
    	/*!
    	 * \brief Public constructor of the DLL
    	 ...
    	 *  stepsize.
    	 */
    	dll_cc_impl(unsigned int osf, float gamma);   // public constructor
    	
    	/*! \brief Public deconstructor of the DLL */	
    	~dll_cc_impl ();  // public destructor
...
#endif /* INCLUDED_CCSDS_DLL_CC_IMPL_H */
