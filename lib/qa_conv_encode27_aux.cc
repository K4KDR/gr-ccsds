...
namespace gr {
  namespace ccsds {
    ...
    void qa_conv_encode27_aux::test_zeroes_12() {
      ...
      const unsigned int num_expect[len] = {16,16,16,16,16};
    ...
    void qa_conv_encode27_aux::test_asm_12() {
      ...
      const unsigned int num_expect[len] = {16,16,16,16};
    ...
    void qa_conv_encode27_aux::test_asm_23() {
      ...
      const unsigned int num_expect[len] = {12,12,12,12};
    ...
    void qa_conv_encode27_aux::test_asm_34() {
      ...
      const unsigned int num_expect[len] = {11,11,10,11};
    ...
    void qa_conv_encode27_aux::test_asm_56() {
      ...
      const unsigned int num_expect[len] = {10,10, 9,10};
    ...
    void qa_conv_encode27_aux::test_asm_78() {
      ...
      const unsigned int num_expect[len] = {10, 9, 9, 9, 9};
