...
namespace gr {
  namespace ccsds {
    ...
    public:
    	 ...
    	 */
    	conv_encode27_aux(uint8_t gen_poly_c1=0x79, uint8_t gen_poly_c2=0xDB, conv_puncturing27::punct_t puncturing=conv_puncturing27::NONE);
